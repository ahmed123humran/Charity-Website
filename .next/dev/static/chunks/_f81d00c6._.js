...
function WebsitesPage() {
    ...
    const fetchWebsites = async ()=>{
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error('Failed to load websites');
        } finally{
            setLoading(false);
        }
    };
    ...
    const confirmDelete = async ()=>{
        if (!deleteId) return;
        try {
            const res = await fetch(`/api/websites/${deleteId}`, {
                method: 'DELETE'
            });
            if (res.ok) {
                fetchWebsites();
...
_s(WebsitesPage, "JmyqnxnA0PX3FiYyVTWwaLZMQ8M=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$intl$2f$dist$2f$esm$2f$development$2f$react$2d$client$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTranslations"],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$intl$2f$dist$2f$esm$2f$development$2f$react$2d$client$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTranslations"],
...
//# sourceMappingURL=_f81d00c6._.js.map