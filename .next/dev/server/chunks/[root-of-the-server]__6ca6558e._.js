...
async function GET(request) {
    try {
        const users = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$utils$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].user.findMany({
            include: {
                pages: true
            }
        });
...
async function POST(request) {
    try {
        ...
        const validation = __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$utils$2f$validiton$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createUserSchema"].safeParse(body);
        ...
        const exists = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$utils$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].user.findUnique({
            where: {
        ...
        const newUser = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$utils$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].user.create({
            data: {
                ...validation.data,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6ca6558e._.js.map