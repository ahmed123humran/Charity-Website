...
async function GET(request, { params }) {
    try {
        ...
        const menu = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$utils$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].menu.findUnique({
            where: {
                id
            },
            include: {
...
async function PUT(request, { params }) {
    try {
        ...
        const validation = __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$utils$2f$validiton$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateMenuSchema"].safeParse(body);
        ...
        const updatedMenu = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$utils$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].menu.update({
            where: {
                id
            },
            data: {
...
async function DELETE(request, { params }) {
    try {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$utils$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].menu.delete({
            where: {
                id
            }
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2e09c83c._.js.map