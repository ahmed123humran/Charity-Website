...
"[project]/app/api/websites/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        const websites = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$utils$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].website.findMany({
            include: {
                pages: true,
                menus: true
            }
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(websites, {
            status: 200
        });
    } catch (error) {
...
async function POST(request) {
    try {
        ...
        const validation = __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$utils$2f$validiton$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createWebsiteSchema"].safeParse(body);
        ...
        const newWebsite = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$utils$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].website.create({
            data: validation.data
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(newWebsite, {
            status: 201
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a138b7f6._.js.map