module.exports = [
"[project]/app/[locale]/admin/users/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            if (res.ok) {
                closeModal();
                fetchUsers();
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].success(isEditing ? 'User updated successfully' : 'User created successfully');
            } else {
                const err = await res.json();
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].error(err.message || 'Error occurred');
            }
        } catch (error) {
            console.error(`Failed to ${isEditing ? 'update' : 'create'} user:`, error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].error(`Failed to ${isEditing ? 'update' : 'create'} user`);
        }
    };
...
//# sourceMappingURL=_f98fcc8f._.js.map