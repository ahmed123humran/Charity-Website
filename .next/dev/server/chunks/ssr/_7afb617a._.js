module.exports = [
"[project]/app/[locale]/admin/tools/search-replace/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function SearchReplaceTool() {
    ...
    const [isReplacing, setIsReplacing] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const handleSearch = async ()=>{
        if (!searchText.trim()) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].error('Please enter text to search');
            return;
        }
        setIsSearching(true);
        setResults([]);
        try {
            ...
            if (res.ok) {
                ...
                if (data.results.length === 0) {
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])('No matches found', {
                        icon: '🔍'
                    });
                }
            } else {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].error('An error occurred during search');
        } finally{
    ...
    const handleReplace = async ()=>{
        ...
        try {
            ...
            if (res.ok) {
                const data = await res.json();
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].success(`Successfully replaced in ${data.count} locations`);
                setResults([]);
                setShowConfirm(false);
                setSearchText('');
                setReplaceText('');
            } else {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].error('Replace operation failed');
            }
        } catch (error) {
            console.error('Replace error:', error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].error('An error occurred during replacement');
        } finally{
...
//# sourceMappingURL=_7afb617a._.js.map